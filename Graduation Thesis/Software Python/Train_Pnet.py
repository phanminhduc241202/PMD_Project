...
def main():
    ...
    dataloaders = {
        ...
        'val': DataLoader(
            ...
            batch_size=batch_size,
            shuffle=True,  # Matches your original code
            num_workers=4,
            pin_memory=True
        )
    }
    ...
    best_loss = 100.0  # Matches your initial best_loss
    ...
    save_path = "C:/Minh_Duc/MD_Personal/LVTN/Training_MTCNN/weights/Pnet_weight.pth"

...
rnet_positive_file = "C:/Minh_Duc/MD_Personal/LVTN/Training_MTCNN/output/anno_store/pos_48_train.txt"
rnet_part_file = "C:/Minh_Duc/MD_Personal/LVTN/Training_MTCNN/output/anno_store/part_48_train.txt"
rnet_neg_file = "C:/Minh_Duc/MD_Personal/LVTN/Training_MTCNN/output/anno_store/neg_48_train.txt"
imglist_filename = "C:/Minh_Duc/MD_Personal/LVTN/Training_MTCNN/output/anno_store/imglist_anno_48_train_Nol.txt"
#onet_landmark_file = "C:/Minh_Duc/MD_Personal/LVTN/Training_MTCNN/output/anno_store/landmark_48_val.txt"
...
if __name__ == '__main__':
    ...
    try:
        ...
        print(f"ONet train annotation result file path: {imglist_filename}")

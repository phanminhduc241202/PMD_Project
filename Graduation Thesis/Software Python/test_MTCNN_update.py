...
pnet.load_state_dict(torch.load('C:/Minh_Duc/MD_Personal/LVTN/Training_MTCNN/weights/Pnet_weight_v2.pth', map_location=device))
...
onet.load_state_dict(torch.load('C:/Minh_Duc/MD_Personal/LVTN/Training_MTCNN/weights/Onet_weight_v2_Nol.pth', map_location=device))
...
# Image loading
image_path = "C:/Users/ADMIN/Downloads/AI_Dataset/Shopping/Sh_84.png"
...
# Parameters
min_face_size = 20.0
thresholds = [0.6, 0.6, 0.5]  # O-Net threshold at 0.7
nms_thresholds = [0.7, 0.7, 0.9]

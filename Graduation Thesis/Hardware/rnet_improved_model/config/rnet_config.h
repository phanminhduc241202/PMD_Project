...
// #define INPUT_SIZE 5
// #define PADDING 0
#define CONV2_IN_CHANNEL CONV1_FILTER
#define CONV2_SIZE 3
#define CONV2_OUT_SIZE (POOL1_OUT_SIZE - CONV2_SIZE + 1)
#define CONV2_FILTER 32
#define MP2_SIZE 3
...
// #define INPUT_SIZE 3
#define PADDING 0
#define CONV3_IN_CHANNEL CONV2_FILTER
#define CONV3_SIZE 2
#define CONV3_OUT_SIZE (POOL2_OUT_SIZE - CONV3_SIZE + 1)
#define CONV3_FILTER 64

#define SEB_CHANNEL_IN 64
#define REDUCTION_FACTOR 8
#define GLOBAL_AVERAGE_OUT 1
#define GLOBAL_AVERAGE_STRIDE 3
#define GLOBAL_AVERAGE_SIZE 3
#define SEB_FC1_FILTER_IN 64
#define SEB_FC1_FILTER_OUT 8
#define SEB_FC2_FILTER_IN 8
#define SEB_FC2_FILTER_OUT 64

// #define INPUT_SIZE 1
#define FC1_DENSE_SIZE 128
...
void rnet_accel(    float* input, 
//                    float* conv_mp_2_weights,
//                    float* conv_3_weights,
